...
def surveyQuestions(SYSTEM_PROMPT: str, survey_data: Dict[Any, Any]) -> Dict[str, str]:
    ...
    print(f"DEBUG: Question count from trainer to be generated by AI service: {survey_data.get('questionCount')}")
...
def SlideDeckGenerator(SYSTEM_PROMPT: str,AI_Summary: str, survey_data: Dict[Any, Any]):
